...
namespace aloe
{
	...
	struct type_node_t : public node_t
	{
		...
		type_node_t(type_e type_type, node_ptr_t definition) :node_t(TYPE_NODE), type_type(type_type), ref_count(0), type_definition(definition){};

		size_t     ref_count;
		type_e	   type_type;
		identifier_node_ptr_t id;
		node_ptr_t type_definition;
